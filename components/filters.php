  ...
  <div class="button-filters col-12 col-md-6">
    ...
    <div class="row py-2">
      <div class="col-3 pe-1">
        <button class="filter text-1 font-13">Precio menor</button>
      </div>
      <div class="col-3 pe-1">
        <button class="filter text-1 font-13">Precio mayor</button>
      </div>
      <div class="col-3 pe-1">
        <button class="filter text-1 font-13">Más reciente</button>
      </div>
      <div class="col-3 pe-1">
        <button class="filter text-1 font-13">Más reciente</button>
      </div>
