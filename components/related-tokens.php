<section class="splide" aria-label="Splide Basic HTML Example">
  <h2 class="text-1 title-2 row py-5">Tokens destacados</h2>
  <div class="splide__track">
    <ul class="splide__list mt-5">
      <li class="splide__slide">
        <div data-bs-toggle="modal" data-bs-target="#exampleModal" class="product-1 row">
          <header class="col-12 py-2">
            <h3 class="product-1-title font-17">Nombre producto</h3>
          </header>
          <img class="col-12" src="./assets/img/PRODUCT-IMAGE.png" alt="Imagen de un token">
          <div class="w-100 py-3 d-flex">
            <h4 class="font-13 product-1-actual-bid w-75">Oferta Actual: <span class="ms-1 product-1-bid"><strong class="mt-1 font-10">0.141 ETH</strong></span></h4>
          ...
          <footer class="d-flex justify-content-between py-3">
            ...
            <div class="col-6 d-flex justify-space-between align-items-center gap-2">
              <div class="collection-img"></div>
              <small class="text-wrap">Nombre coleccion</small>
            </div>
          </footer>
        </div>
      </li>
