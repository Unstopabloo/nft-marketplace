      ...
      <li class="splide__slide">
        <a href="#" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="product-1 row">
          ...
          <div class="w-100 py-3 d-flex">
            <h4 class="font-13 product-1-actual-bid w-75">Oferta Actual: <div class="ms-1 product-1-bid"><strong class="mt-1 font-10">0.141 ETH</strong></div></h4>
